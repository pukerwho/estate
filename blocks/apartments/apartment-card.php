			...
			<div class="b_apartments__info">
				<div>
					<div class="b_apartments__info__tr">
						<img src="<?php bloginfo('template_url') ?>/img/icon-price.png" alt=""> <span class="color-black font-weight-bold">от <?php echo carbon_get_the_post_meta('crb_apartments_price'); ?> &euro;&nbsp; </span><span> / <?php echo carbon_get_the_post_meta('crb_apartments_square_price'); ?> &euro; м<sup>2</sup></span>
					</div>
					<div class="b_apartments__info__tr">
